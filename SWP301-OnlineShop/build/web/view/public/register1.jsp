...
<html>
    ...
    <body>
        ...
        <div class="container" style="margin-bottom: 30px;">
            <form class="form-horizontal" role="form" action="register" method="post" id="registerForm">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="email" id="lastName" name="txtEmail" placeholder="Enter email address" class="form-control" autofocus required>
                    </div>
                </div>
                <div class="form-group">
                    <label for="email" class="col-sm-3 control-label">Mobile </label>
                    <div class="col-sm-9">
                        <input type="text" id="email" name="txtMobile" placeholder="Enter your mobile" class="form-control" required>
                    </div>
                </div>
                <div class="form-group">
                    <label for="email" class="col-sm-3 control-label">Address </label>
                    <div class="col-sm-9">
                        <textarea class="form-control" rows="4" placeholder="Enter your address" name="txtAddress" required></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="password" class="col-sm-3 control-label">Password*</label>
                    <div class="col-sm-9">
                        <input type="password" id="password" name="txtPassword" placeholder="Password" class="form-control" required >
                    </div>
                </div>
                <div class="form-group">
                    <label for="password" class="col-sm-3 control-label">Confirm Password*</label>
                    <div class="col-sm-9">
                        <input type="password" name="txtPassword1" placeholder="Confirm Password" class="form-control" required>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <label class="radio-inline">
                                    <input type="radio" name="rd" id="maleRadio" value="1">Male
                                </label>
                            </div>
                        </div>
                    </div>
