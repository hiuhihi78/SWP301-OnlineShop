                    ...
                    <div id="content" style="width: 80%; margin: 0 9%" >
                        ...
                        <div class="row mb-3" style="margin-bottom: 20px">
                            <c:if test="${requestScope.user.avatar != null}">
                                <img src="${user.avatar}"  class="img-circle" alt="User imafe" width="250" height="250"> 
                            </c:if>
                            <c:if test="${requestScope.user.avatar == null}">
                                <img src="../assets/img/defaultUserAvatar.png"  class="img-circle" alt="User image" width="300" height="300"> 
                            </c:if>
                        </div>
                        <div class="row mb-3">
